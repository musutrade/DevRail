...
use crate::models::{
    ...
    DevRailApprovalPage, DevRailApprovalResponse, DevRailBranchResponse, DevRailChangesetResponse,
    DevRailEnvironmentHealthResponse, DevRailEnvironmentPage, DevRailEnvironmentResponse,
    DevRailExternalReviewCommentResponse, DevRailGitProviderResponse, DevRailListQuery,
...
#[openapi(
    ...
    components(schemas(
        ...
        UpdateDevRailProjectRequest, UpdateDevRailProjectPolicyRequest, CreateDevRailRepositoryRequest, CreateDevRailPullRequestRequest, CreateDevRailBranchRequest, SyncDevRailPullRequestRequest, SyncDevRailExternalReviewRequest, DevRailPullRequestWebhookRequest,
